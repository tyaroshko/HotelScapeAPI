...
Revision ID: f2b79e53eed0
Revises: 
Create Date: 2022-08-07 12:28:55.164623
...
def upgrade() -> None:
    ...
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('name', sa.String(), nullable=False),
    sa.Column('number_of_beds', sa.Enum('single_bed', 'double_beds', 'twin_beds', 'king_size_bed', name='numberofbeds'), nullable=True),
    ...
    sa.PrimaryKeyConstraint('room_type_id', 'feature_id')
    )
    ...
    sa.Column('booking_status', sa.Enum('vacant', 'booked', 'occupied', name='roombookingstatus'), nullable=True),
    ...
    sa.Column('ts_paid', sa.DateTime(), nullable=True),
